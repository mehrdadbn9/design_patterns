""
	Builder:دیزاین پترن builder زمانی استفاده میشه که ما یک محصولی قراره بسازیم که اون محصول از اجزای کوچکتری
	ساخته شده که اون اجزای کوچکتر هم باید ایجاد بشن تا ما بتونیم از اونها استفاده کنیم
"""
class Director:
	__builder = None
